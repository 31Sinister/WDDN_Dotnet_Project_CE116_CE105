...
<body>
    ...
    <div id="top">
        ...
        <asp:Menu ID="Menu1" runat="server" Orientation="Horizontal" Width="100%" 
            BackColor="#ffffff" BorderColor="#ffffff" BorderStyle="Solid" BorderWidth="2px">
            <Items>
...
<a style="display:none" href="http://wowslider.com">Script Image Slider by WOWSlider.com v1.7</a>
    ...
    <div id="footer" 
        style="color: #FFFFFF; text-align: center; vertical-align: middle;">Made By Jeet and Aksh</div>
    </form>
</body>
</html>
